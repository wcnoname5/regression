...
dta %>%
  ...
  ggpairs() + ggtitle("Case1: Full model is true model")
ggsave("fig1.png", width = 8, height = 5)
dta %>%
  select(c(starts_with("x"),"y2")) %>%
  ggpairs() + ggtitle("Case2: x2, x5, x7 are irrelevant vars")
